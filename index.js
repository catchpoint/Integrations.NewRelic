 ...
 * constructs timeseries object and writes timeseries object to New Relic Metrics API. 
 */
 ...
 */
function processTracertTestData(testId, nodeName, timestamp, testData, metrics) {
	let data;
	let sumPingTime = 0;
